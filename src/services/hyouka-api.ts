...
export interface IFileService {
    download(action: string | null, path: string | null): Promise<FileResponse | null>;
    navigate(command: ActionCommand | null): Promise<FileResultEnvelope | null>;
    fileAction(command: ActionCommand | null): Promise<ActionResultEnvelope | null>;
    getContent(command: ActionCommand | null): Promise<ContentEnvelope | null>;
    upload(uploadModel?: FileUploadModel | null | undefined): Promise<ActionResultEnvelope | null>;
}
...
export class FileService extends BaseClass implements IFileService {
    ...
    upload(uploadModel?: FileUploadModel | null | undefined): Promise<ActionResultEnvelope | null> {
        ...
        if (uploadModel !== null && uploadModel !== undefined)
            content_.append("uploadModel", uploadModel.toString());
...
export class FileUploadModel implements IFileUploadModel {
    ...
    files?: KeyValuePairOfStringAndStringValues[] | null;
    ...
    init(data?: any, _mappings?: any) {
        if (data) {
            this.destination = data["destination"] !== undefined ? data["destination"] : <any>null;
            if (data["files"] && data["files"].constructor === Array) {
                this.files = [];
                for (let item of data["files"])
                    this.files.push(KeyValuePairOfStringAndStringValues.fromJS(item, _mappings));
            }
        }
    }

    static fromJS(data: any, _mappings?: any): FileUploadModel {
        data = typeof data === 'object' ? data : {};
        return createInstance<FileUploadModel>(data, _mappings, FileUploadModel);
    }
...
export class KeyValuePairOfStringAndStringValues implements IKeyValuePairOfStringAndStringValues {
    ...
    static fromJS(data: any, _mappings?: any): KeyValuePairOfStringAndStringValues {
        data = typeof data === 'object' ? data : {};
        return createInstance<KeyValuePairOfStringAndStringValues>(data, _mappings, KeyValuePairOfStringAndStringValues);
    }
